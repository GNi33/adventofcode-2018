...
internal class GuardSpyTest {
    ...
    fun getGuardAsleepLongest() {
        ...
        val guards = guardSpy.parseInput(lines)
        val longestAsleepguard = guardSpy.getGuardLongestAsleep(guards)

        assertEquals(10, longestAsleepguard.id)
    }

    @Test
    fun getMinuteMostAsleep() {
        val guardSpy = GuardSpy()
        ...
        assertEquals(24, longestAsleepguard.getMinuteAsleepMost())
    }

    @Test
    fun getGuardAsleepMostFrequent() {
        val guardSpy = GuardSpy()
